...
public class FilterGreaterThenSpeakingCommand extends AbstractCommand{
    private final CollectionManager collectionManager;
    private final OutputManager outputManager;
    private final CommandManager commandManager;

    public FilterGreaterThenSpeakingCommand(CollectionManager collectionManager, OutputManager outputManager, CommandManager commandManager){
        super("filter_greater_than_speaking", "Выводит все элементы, у которых значение speaking больше(?) заданного");
