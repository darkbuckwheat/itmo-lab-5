...
public class RemoveLowerCommand extends AbstractCommand{
    ...
    public RemoveLowerCommand(CollectionManager collectionManager, OutputManager outputManager,
                              CommandManager commandManager, DragonCreator dragonCreator){
        super("remove_lower", "Удаляет из коллекции элементы, меньшие, чем введённый");
